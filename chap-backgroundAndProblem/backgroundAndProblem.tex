...
% \subsection{History}
% As a new mode of transportation, they have .
% A short history and different types of carsharing systems are 
% They represent a real alternative to private vehicle 
...
This service is a real alternative to private car and releases the user from constraints related to individual property, since the carsharing company is in charge of insurance, maintenance, fuel (or electricity), taxes, depreciation, etc.
