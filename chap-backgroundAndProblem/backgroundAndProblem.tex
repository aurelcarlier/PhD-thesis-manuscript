\chapter{Background} \label{chap:backAndPb}
\minitoc
\vfill
%\epigraph{A clever person solves a problem. A wise person avoids it.}{\textit{Albert Einstein}}
\noindent
\begin{minipage}[b]{0.25\linewidth}
\centering
\includegraphics[width=.75\textwidth]{cube2}\\
~\\
\flushleft
